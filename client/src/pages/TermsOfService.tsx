        ...
        <div className="text-center mb-10 sm:mb-12">
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-slate-600 mt-1 sm:mt-2 text-sm sm:text-base">디컴소프트 AI 한글 에디터 서비스 이용약관</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-5 sm:p-8 space-y-8">
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-slate-900">제1조 (목적)</h2>
            </div>
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-slate-900">제2조 (정의)</h2>
            </div>
            <div className="bg-[#f8f9fc]/50 rounded-lg p-4 sm:p-6 border border-slate-200">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={i} className="bg-white rounded-lg p-4 border border-slate-200">
                    <h3 className="font-semibold text-slate-800 mb-2 text-sm">{i + 1}. {term}</h3>
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-slate-900">제3조 (약관의 명시와 설명 및 개정)</h2>
            </div>
            <div className="bg-[#f8f9fc]/50 rounded-lg p-4 sm:p-6 border border-slate-200 space-y-4">
              <div>
                <h3 className="font-semibold text-slate-800 mb-2 text-sm">① 약관의 명시</h3>
              ...
              <div>
                <h3 className="font-semibold text-slate-800 mb-2 text-sm">② 약관의 개정</h3>
              ...
              <div>
                <h3 className="font-semibold text-slate-800 mb-2 text-sm">③ 개정 공지</h3>
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-slate-900">제4조 (서비스의 제공 및 변경)</h2>
            </div>
            <div className="bg-[#f8f9fc]/50 rounded-lg p-4 sm:p-6 border border-slate-200 space-y-4">
              <div>
                <h3 className="font-semibold text-slate-800 mb-2 text-sm">① 제공 서비스</h3>
              ...
              <div>
                <h3 className="font-semibold text-slate-800 mb-2 text-sm">② 서비스 변경</h3>
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-slate-900">제5조 (회원가입)</h2>
            </div>
            <div className="bg-[#f8f9fc]/50 rounded-lg p-4 sm:p-6 border border-slate-200 space-y-4">
              <div>
                <h3 className="font-semibold text-slate-800 mb-2 text-sm">① 가입 신청</h3>
                <p className="text-slate-600 text-sm">이용자는 회사가 정한 가입 양식에 따라 회원정보를 기입한 후 이 약관에 동의한다는 의사표시를 함으로서 회원가입을 신청합니다.</p>
              </div>
              <div>
                <h3 className="font-semibold text-slate-800 mb-2 text-sm">② 가입 승낙</h3>
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-slate-900">제9조 (개인정보보호)</h2>
            </div>
            <div className="bg-[#f8f9fc]/50 rounded-lg p-4 sm:p-6 border border-slate-200 space-y-4">
              <div>
                <h3 className="font-semibold text-slate-800 mb-2 text-sm">① 개인정보 수집</h3>
                <p className="text-slate-600 text-sm">회사는 AI 한글 에디터 서비스 제공을 위해 필요한 최소한의 개인정보를 수집합니다.</p>
              </div>
              <div>
                <h3 className="font-semibold text-slate-800 mb-2 text-sm">② 개인정보 보호</h3>
                <p className="text-slate-600 text-sm">회사는 개인정보보호법에 따라 이용자의 개인정보를 보호하며, 개인정보처리방침에 따라 개인정보를 처리합니다.</p>
              </div>
              <div>
                <h3 className="font-semibold text-slate-800 mb-2 text-sm">③ 개인정보 제3자 제공</h3>
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-slate-900">제11조 (면책조항)</h2>
            </div>
            <div className="bg-[#f8f9fc]/50 rounded-lg p-4 sm:p-6 border border-slate-200 space-y-4">
              <div>
                <h3 className="font-semibold text-slate-800 mb-2 text-sm">① 천재지변 등</h3>
                <p className="text-slate-600 text-sm">회사는 천재지변 또는 이에 준하는 불가항력으로 인하여 서비스를 제공할 수 없는 경우에는 서비스 제공에 관한 책임이 면제됩니다.</p>
              </div>
              <div>
                <h3 className="font-semibold text-slate-800 mb-2 text-sm">② 이용자 귀책사유</h3>
                <p className="text-slate-600 text-sm">회사는 이용자의 귀책사유로 인한 서비스 이용의 장애에 대하여는 책임을 지지 않습니다.</p>
              </div>
              <div>
                <h3 className="font-semibold text-slate-800 mb-2 text-sm">③ 무료 서비스</h3>
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-slate-900">제12조 (준거법 및 관할법원)</h2>
            </div>
            <div className="bg-[#f8f9fc]/50 rounded-lg p-4 sm:p-6 border border-slate-200 space-y-4">
              <div>
                <h3 className="font-semibold text-slate-800 mb-2 text-sm">① 준거법</h3>
                <p className="text-slate-600 text-sm">회사와 이용자 간에 제기된 전자상거래 소송에는 대한민국법을 적용합니다.</p>
              </div>
              <div>
                <h3 className="font-semibold text-slate-800 mb-2 text-sm">② 관할법원</h3>
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-slate-900">부칙</h2>
            </div>
            <div className="bg-[#f8f9fc]/50 rounded-lg p-4 sm:p-6 border border-slate-200">
