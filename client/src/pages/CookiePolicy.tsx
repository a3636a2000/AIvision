  ...
  return (
    <SmartFactoryWrapper>
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="text-center mb-10 sm:mb-12">
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-slate-600 mt-1 sm:mt-2 text-sm sm:text-base">디컴소프트 쿠키 사용 정책</p>
            </div>
          </div>
        ...
        {/* 메인 콘텐츠 */}
        <div className="bg-white rounded-xl border border-slate-200 p-5 sm:p-8 space-y-8">
          {/* 1. 쿠키란 무엇인가요? */}
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-slate-900">1. 쿠키란 무엇인가요?</h2>
            </div>
            <div className="bg-[#f8f9fc]/50 rounded-lg p-4 sm:p-6 border border-slate-200">
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-slate-900">2. DECOMSOFT의 쿠키 사용 목적</h2>
            </div>
            <div className="bg-[#f8f9fc]/50 rounded-lg p-4 sm:p-6 border border-slate-200">
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-slate-900">3. 쿠키의 종류</h2>
            </div>
            <div className="bg-[#f8f9fc]/50 rounded-lg p-4 sm:p-6 border border-slate-200 space-y-6">
              {/* 지속 기간별 분류 */}
              <div>
                <h3 className="font-semibold text-slate-800 mb-3 text-sm">지속 기간별 분류</h3>
                <div className="overflow-x-auto">
                  <table className="w-full border border-slate-200 rounded-lg text-sm">
                    <thead className="bg-gray-700">
                      <tr>
                        <th className="px-4 py-3 text-left font-medium text-slate-700 border-b border-slate-300">쿠키 유형</th>
                        <th className="px-4 py-3 text-left font-medium text-slate-700 border-b border-slate-300">설명</th>
                        <th className="px-4 py-3 text-left font-medium text-slate-700 border-b border-slate-300">보존 기간</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
              ...
              {/* 기능별 분류 */}
              <div>
                <h3 className="font-semibold text-slate-800 mb-3 text-sm">기능별 분류</h3>
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-slate-900">4. 사용 중인 쿠키 목록</h2>
            </div>
            <div className="bg-[#f8f9fc]/50 rounded-lg p-4 sm:p-6 border border-slate-200">
              <div className="overflow-x-auto">
                <table className="w-full border border-slate-200 rounded-lg text-sm">
                  <thead className="bg-gray-700">
                    <tr>
                      <th className="px-4 py-3 text-left font-medium text-slate-700 border-b border-slate-300">쿠키명</th>
                      <th className="px-4 py-3 text-left font-medium text-slate-700 border-b border-slate-300">목적</th>
                      <th className="px-4 py-3 text-left font-medium text-slate-700 border-b border-slate-300">유형</th>
                      <th className="px-4 py-3 text-left font-medium text-slate-700 border-b border-slate-300">보존기간</th>
                    </tr>
                  </thead>
                  <tbody>
                    {[
                      ...
                      <tr key={i}>
                        <td className="px-4 py-3 text-slate-700 border-b border-slate-200 font-mono">{cookie.name}</td>
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-slate-900">5. 쿠키 관리 방법</h2>
            </div>
            <div className="bg-[#f8f9fc]/50 rounded-lg p-4 sm:p-6 border border-slate-200 space-y-6">
              <div>
                <h3 className="font-semibold text-slate-800 mb-3 text-sm">브라우저별 쿠키 설정 방법</h3>
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={i} className="bg-white rounded-lg p-4 border border-slate-200">
                      <h4 className="font-semibold text-slate-800 mb-2 text-sm">{browser.name}</h4>
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-slate-900">6. 쿠키 거부 시 영향</h2>
            </div>
            <div className="bg-[#f8f9fc]/50 rounded-lg p-4 sm:p-6 border border-slate-200">
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-slate-900">7. 정책 변경</h2>
            </div>
            <div className="bg-[#f8f9fc]/50 rounded-lg p-4 sm:p-6 border border-slate-200 space-y-4">
              <div>
                <h3 className="font-semibold text-slate-800 mb-2 text-sm">① 변경 통지</h3>
              ...
              <div>
                <h3 className="font-semibold text-slate-800 mb-2 text-sm">② 시행일</h3>
                <p className="text-slate-600 text-sm">
